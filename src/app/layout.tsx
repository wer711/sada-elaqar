      ...
      >
        ...
        <Script id="sada-config" strategy="beforeInteractive">
          {`
            ...
            // Pre-stub window.sada so calls before track.js loads don't throw.
            // If track.js loads successfully, it will overwrite this stub.
            if (!window.sada) {
              window.sada = {
                track: function() {},
                page: function() {},
            ...
            // Safe wrapper: try/catch so tracking errors never break the site.
            window.__sadaSafeTrack = function(name, props) {
              try {
                ...
                // Silently ignore — never break user experience
              }
            };
          `}
        </Script>
